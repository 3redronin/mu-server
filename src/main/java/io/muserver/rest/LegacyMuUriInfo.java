...
import static io.muserver.rest.LegacyReadOnlyMultivaluedMap.readOnly;
import static java.util.stream.Collectors.toList;

class LegacyMuUriInfo implements UriInfo {
    static {
    ...
    LegacyMuUriInfo(URI baseUri, URI requestUri, String encodedRelativePath, List<String> matchedURIs, List<Object> matchedResources) {
    ...
    static Stream<LegacyMuPathSegment> pathStringToSegments(String path, boolean encodeSlashes) {
        ...
        return stream
            ...
            .map(s -> {
                ...
                return new LegacyMuPathSegment(segments[0], params);
            });
    }
