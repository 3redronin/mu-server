 ...
 * </p>
 * <p>
 * A mapper for {@link Throwable} is registered by default on each {@link RestHandlerBuilder}. Use
 * {@link ProblemDetailsExceptionMapperBuilder#problemDetailsExceptionMapper()} to create a customized mapper, or
 * {@link RestHandlerBuilder#removeExceptionMapper(Class)} to remove the default mapping.
 * </p>
 *
