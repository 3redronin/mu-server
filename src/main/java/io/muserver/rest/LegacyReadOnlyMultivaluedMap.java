 ...
 */
class LegacyReadOnlyMultivaluedMap<K, V> implements MultivaluedMap<K, V>, Serializable {
    private static final MultivaluedMap EMPTY = readOnly(new MultivaluedHashMap<>());
    private final MultivaluedMap<K, V> actual;

    private LegacyReadOnlyMultivaluedMap(MultivaluedMap<K, V> actual) {
        this.actual = actual;
    }

    static <K, V> MultivaluedMap<K, V> readOnly(MultivaluedMap<K, V> map) {
        return new LegacyReadOnlyMultivaluedMap<>(map);
    }
