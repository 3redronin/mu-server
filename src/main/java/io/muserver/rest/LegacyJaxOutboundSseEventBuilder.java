...
class LegacyJaxOutboundSseEventBuilder implements OutboundSseEvent.Builder {
    private String id;
    private String name;
    ...
    public OutboundSseEvent build() {
        ...
        return new LegacyJaxOutboundSseEvent(id, name, milliseconds, mediaType, comment, type, data, genericType);
    }
}
