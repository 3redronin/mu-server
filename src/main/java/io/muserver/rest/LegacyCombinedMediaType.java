 ...
 */
class LegacyCombinedMediaType implements Comparable<LegacyCombinedMediaType> {

    public static LegacyCombinedMediaType NONMATCH = new LegacyCombinedMediaType(null, null, 1.0, 1.0, 0, null);
    ...
    LegacyCombinedMediaType(String type, String subType, double q, double qs, int d, String charset) {
        this.type = type;
    ...
    public static LegacyCombinedMediaType s(MediaType clientType, MediaType serverType) {
        ...
        return new LegacyCombinedMediaType(type, sub, q, qs, d, serverType.getParameters().get("charset"));
    }

    @Override
    public int compareTo(LegacyCombinedMediaType o) {
    ...
    public boolean equals(Object o) {
        ...
        LegacyCombinedMediaType that = (LegacyCombinedMediaType) o;
