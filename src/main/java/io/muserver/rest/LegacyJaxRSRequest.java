...
class LegacyJaxRSRequest implements Request, ContainerRequestContext, ReaderInterceptorContext {

    final MuRequest muRequest;
    private final MuResponse muResponse;
    private InputStream inputStream;
    private final String relativePath;
    private final LegacyJaxRsHttpHeadersAdapter jaxHeaders;
    ...
    private final LegacyEntityProviders entityProviders;
    private String httpMethod;

    LegacyJaxRSRequest(MuRequest muRequest, MuResponse muResponse, InputStream inputStream, String relativePath, SecurityContext securityContext, List<ReaderInterceptor> readerInterceptors, LegacyEntityProviders entityProviders) {
        ...
        this.uriInfo = createUriInfo(relativePath, null, muRequest.uri().resolve(basePath), muRequest.uri());
        this.jaxHeaders = new LegacyJaxRsHttpHeadersAdapter(muRequest.headers(), muRequest.cookies());
    }
    ...
    public void setRequestUri(URI baseUri, URI requestUri) {
        ...
        this.uriInfo = createUriInfo(baseUri.relativize(requestUri).getRawPath(), null, baseUri, absoluteUri);
    }
    ...
    public Variant selectVariant(List<Variant> variants) {
        ...
        return LegacyMuVariantListBuilder.selectVariant(variants, ranges, getAcceptableMediaTypes(), muRequest.headers().acceptEncoding());
    }
    ...
    public void setMediaType(MediaType mediaType) {
        if (mediaType == null) {
            ...
            jaxHeaders.getMutableRequestHeaders().putSingle("content-type", LegacyMediaTypeParser.toString(mediaType));
        }
    }
    ...
    void setMatchedMethod(RequestMatcher.MatchedMethod matchedMethod) {
        ...
        this.uriInfo = createUriInfo(relativePath, matchedMethod, uriInfo.getBaseUri(), uriInfo.getRequestUri());
    }
    ...
    static LegacyMuUriInfo createUriInfo(String relativePath, RequestMatcher.MatchedMethod mm, URI baseUri, URI requestUri) {
