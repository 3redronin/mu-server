...
public class SecuritySchemeObjectBuilder {
     ...
     * @return this builder */
    public SecuritySchemeObjectBuilder withExtensions(@Nullable Map<String, Object> value) { this.extensions = value; return this; }
    /**
     * @param name an x- extension name
     * @param value its JSON value
     * @return this builder */
    public SecuritySchemeObjectBuilder withExtension(String name, @Nullable Object value) {
