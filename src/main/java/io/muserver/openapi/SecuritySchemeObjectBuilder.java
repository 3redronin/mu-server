...
public class SecuritySchemeObjectBuilder {
    ...
    private @Nullable OAuthFlowsObject flows;
    private @Nullable URI openIdConnectUrl;

    /**
     * Creates an empty security scheme object builder.
     */
     ...
     * @return The current builder
     */
    public SecuritySchemeObjectBuilder withName(@Nullable String name) {
        this.name = name;
        return this;
    }

    /**
     * Sets where the security scheme value is supplied.
     *
     ...
     * @return The current builder
     */
    public SecuritySchemeObjectBuilder withIn(@Nullable String in) {
        this.in = in;
        return this;
    }
     ...
     * @return The current builder
     */
    public SecuritySchemeObjectBuilder withScheme(@Nullable String scheme) {
        this.scheme = scheme;
        return this;
    }
     ...
     * @return The current builder
     */
    public SecuritySchemeObjectBuilder withBearerFormat(@Nullable String bearerFormat) {
        this.bearerFormat = bearerFormat;
        return this;
    }

    /**
     * Sets the OAuth flow configuration.
     *
     ...
     * @return The current builder
     */
    public SecuritySchemeObjectBuilder withFlows(@Nullable OAuthFlowsObject flows) {
        this.flows = flows;
        return this;
    }
     ...
     * @return The current builder
     */
    public SecuritySchemeObjectBuilder withOpenIdConnectUrl(@Nullable URI openIdConnectUrl) {
        this.openIdConnectUrl = openIdConnectUrl;
        return this;
    }

    /**
     * Builds a security scheme object from the configured values.
     *
     * @return A new object
     */
