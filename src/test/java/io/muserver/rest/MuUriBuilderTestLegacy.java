...
public class MuUriBuilderTestLegacy {
    static {
    ...
    public void prettyMuchEverythingCanHaveTemplateParameters() {
        UriBuilder builder = new LegacyMuUriBuilder()
            .scheme("http{s}")
    ...
    public void cloneTest() {
        UriBuilder builder = LegacyMuUriBuilder.fromUri(u("http://example.org/blah/?a=b"));
    ...
    public void fromUriObject() {
        UriBuilder builder = LegacyMuUriBuilder.fromUri(u("http://example.org/blah;color=red;size=large/?a=b"));
    ...
    public void fromUriTemplate() {
        assertThat(new LegacyMuUriBuilder().uri(u("http://user:pw@example.org:12000/a%20blah/?a=b%25#hi")).build(),
            equalTo(new LegacyMuUriBuilder().uri("http://user:pw@example.org:12000/a%20blah/?a=b%25#hi").build()));
    }

    @Test
    public void fromUriTemplateWithPlaceholders() {
        assertThat(new LegacyMuUriBuilder()
    ...
    @Test
    public void scheme() {
        assertThat(LegacyMuUriBuilder.fromUri(u("http://example.org/blah")).scheme("https").build().toString(),
            equalTo("https://example.org/blah"));
    }

    @Test
    public void schemeSpecificPart() {
        assertThat(LegacyMuUriBuilder.fromUri(u("https://example.org/blah/"))
    ...
    public void userInfo() {
        UriBuilder builder = LegacyMuUriBuilder.fromUri(u("http://example.org/blah")).userInfo("ha:ho");
    ...
    @Test
    public void host() {
        assertThat(LegacyMuUriBuilder.fromUri(u("http://example.org/blah/")).host("localhost").build().toString(),
            equalTo("http://localhost/blah/"));
    }

    @Test
    public void port() {
        UriBuilder builder = LegacyMuUriBuilder.fromUri(u("http://example.org/blah")).port(8080);
    ...
    public void replacePath() {
        URI uri = LegacyMuUriBuilder.fromUri(u("http://example.org/blah"))
            .replacePath("ha/har")
            .build();
    ...
    public void replaceQueryWithNullValueClearsParams() {
        URI uri = LegacyMuUriBuilder.fromUri(u("http://example.org/blah?hah=ba"))
            .queryParam("a", "b")
            .replaceQuery(null)
            .build();
    ...
    public void replaceQueryParam() {
        URI uri = LegacyMuUriBuilder.fromUri(u("http://example.org/blah?a=b&c=d&e=f"))
    ...
    public void fragment() {
        URI uri = LegacyMuUriBuilder.fromUri(u("http://example.org"))
            .fragment("hello")
            .build();
    ...
    public void resolveTemplateWithSlashEncoded() {
        UriBuilder uri = new LegacyMuUriBuilder()
    ...
    public void buildFromMap() {
        UriBuilder builder = LegacyMuUriBuilder.fromUri("http://localhost:8123/{class}/{method}?some=thing");
        Map<String, Object> map = new HashMap<>();
