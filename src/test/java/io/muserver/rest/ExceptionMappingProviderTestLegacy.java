...
public class ExceptionMappingProviderTestLegacy {
    ...
    public void evenWebApplicationExceptionsCanBeMapped() throws IOException {
        ...
        this.server = ServerUtils.httpsServerForTest()
            .addHandler(
                restHandler(new Sample())
                    .addExceptionMapper(Throwable.class, (ExceptionMapper<Throwable>) exception -> javax.ws.rs.core.Response.status(555)
