...
public class EntityTagDelegateTestLegacy {

    private final RuntimeDelegate.HeaderDelegate<EntityTag> del = new LegacyMuRuntimeDelegate().createHeaderDelegate(EntityTag.class);
