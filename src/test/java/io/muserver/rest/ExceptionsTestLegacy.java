...
public class ExceptionsTestLegacy {
    ...
    public void customExceptionsFromSubResourcesWork() throws Exception {
        ...
        this.server = ServerUtils.httpsServerForTest()
            .addHandler(
                ...
                .addExceptionMapper(CustomException.class, (ExceptionMapper<CustomException>) exception -> javax.ws.rs.core.Response.status(414).entity("Custom exception").build())
            )
            .start();
