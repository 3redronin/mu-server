...
public class ProviderWrapperTestLegacy {
    ...
    private static Type readerType(Object instance) {
        return LegacyProviderWrapper.genericTypeOf(instance, MessageBodyReader.class);
    }

    private static Type writerType(Object instance) {
        return LegacyProviderWrapper.genericTypeOf(instance, MessageBodyWriter.class);
    }

    @Test
    public void itCanFindTheWrapperThatIsClosestToTheType() {
        LegacyProviderWrapper<MessageBodyWriter<?>> stringWriter = createStringWriter();
        LegacyProviderWrapper<MessageBodyWriter<?>> charSequenceWriter = createCharSequenceWriter();
        LegacyProviderWrapper<MessageBodyWriter<?>> objectWriter = createObjectWriter();
        assertThat(LegacyProviderWrapper.compareTo(stringWriter, objectWriter, String.class), equalTo(-1));
        assertThat(LegacyProviderWrapper.compareTo(stringWriter, objectWriter, Object.class), equalTo(1));
        assertThat(LegacyProviderWrapper.compareTo(stringWriter, stringWriter, String.class), equalTo(0));
        assertThat(LegacyProviderWrapper.compareTo(objectWriter, objectWriter, Object.class), equalTo(0));
        assertThat(LegacyProviderWrapper.compareTo(objectWriter, stringWriter, String.class), equalTo(1));
        assertThat(LegacyProviderWrapper.compareTo(objectWriter, stringWriter, Object.class), equalTo(-1));


        assertThat(LegacyProviderWrapper.compareTo(charSequenceWriter, stringWriter, String.class), equalTo(1));
        assertThat(LegacyProviderWrapper.compareTo(stringWriter, charSequenceWriter, String.class), equalTo(-1));
        assertThat(LegacyProviderWrapper.compareTo(charSequenceWriter, stringWriter, CharSequence.class), equalTo(-1));
        assertThat(LegacyProviderWrapper.compareTo(stringWriter, charSequenceWriter, CharSequence.class), equalTo(1));

        assertThat(LegacyProviderWrapper.compareTo(charSequenceWriter, stringWriter, Object.class), equalTo(-1));
        assertThat(LegacyProviderWrapper.compareTo(stringWriter, charSequenceWriter, Object.class), equalTo(1));

    }

    private LegacyProviderWrapper<MessageBodyWriter<?>> createStringWriter() {
        return LegacyProviderWrapper.writer(new MessageBodyWriter<String>() {
    ...
    private LegacyProviderWrapper<MessageBodyWriter<?>> createObjectWriter() {
        return LegacyProviderWrapper.writer(new MessageBodyWriter<Object>() {
            public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
                return true;
            }
    ...
    private LegacyProviderWrapper<MessageBodyWriter<?>> createCharSequenceWriter() {
        return LegacyProviderWrapper.writer(new MessageBodyWriter<CharSequence>() {
            public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
                return true;
            }
