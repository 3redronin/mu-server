...
Intentional / known gaps at the moment:

* `3.3` cleartext prior knowledge / `h2c` paths are not implemented
* `6.6` / `8.4` `PUSH_PROMISE` / server push are not implemented
* `11.2` `h2c` upgrade token is not implemented
* many `8.x` / `9.x` / `10.x` items are only partially covered even though pieces exist in code/tests
 ...
 * 5.3. [x] Prioritization
 * 5.3.1. [x] Background on Priority in RFC 7540
 * 5.3.2. [x] Priority Signaling in This Document
